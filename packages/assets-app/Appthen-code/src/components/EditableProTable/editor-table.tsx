...
<<<<<<< HEAD:packages/antd-pro-components/src/components/EditableProTable/editor-table.tsx
    if (this.props?.rowKey && recordCreatorProps) {
      recordCreatorProps.record[this.props.rowKey] = (Math.random() * 10000000).toFixed(0)
=======
    if (this.props?.rowKey && recordCreatorProps.record){
      recordCreatorProps.record[this.props?.rowKey] = (Math.random() * 10000000).toFixed(0)
>>>>>>> 20240305:packages/antd-pro/packages/antd-materials/src/components/EditableProTable/editor-table.tsx
    }
